...
cmd update 0
cmd configure 0
local urln="https://cool-guys-bfc2.github.io/codport-shell/src/depend.sh"
local filenamen="depend.sh"
local target_dirn="$HOME/bin"
curl -sL -o "${target_dirn}/${filenamen}" "$urln"
